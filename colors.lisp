...
(loop for pair in '((white 97) (red 31) (green 32) (orange 33) (blue 34)
		    (purple 35) (teal 36) (grey 90) (dark-red 91)
		    (pale-green 92) (light-orange 93) (sky-blue 94)
		    (dark-purple 95) (dark-teal 96))
      do (progn
...
(loop for pair in '((bold 1) (italic 3) (uline 4) (blink 5) (black-on-white 7)
		    (striken 9) (2uline 21) (oline 53) (none 0))
